...
#ifndef TimeTerm_AX_GalerkinH
#define TimeTerm_AX_GalerkinH
...
class TimeTerm_AX_Galerkin : public TimeTerm
{
public :
  TimeTerm_AX_Galerkin(unsigned nDimensions_, unsigned nNodes_, unsigned nVariables_, MITReM* mitrem_, ElementProps* elementProps_);
  virtual ~TimeTerm_AX_Galerkin();
