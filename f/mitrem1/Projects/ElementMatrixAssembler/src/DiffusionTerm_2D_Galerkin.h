...
#ifndef DiffusionTerm_2D_GalerkinH
#define DiffusionTerm_2D_GalerkinH
...
class DiffusionTerm_2D_Galerkin : public DiffusionTerm
{
public :
	DiffusionTerm_2D_Galerkin(unsigned nDimensions_, unsigned nNodes_, unsigned nVariables_, MITReM* mitrem_, ElementProps* elementProps_);
	virtual ~DiffusionTerm_2D_Galerkin();
