...
#ifndef HomReactionTerm_2D_GalerkinH
#define HomReactionTerm_2D_GalerkinH
...
class HomReactionTerm_2D_Galerkin : public HomReactionTerm
{
public :
  HomReactionTerm_2D_Galerkin(unsigned nDimensions_, unsigned nNodes_, unsigned nVariables_, MITReM* mitrem_, ElementProps* elementProps_);
  virtual ~HomReactionTerm_2D_Galerkin();
