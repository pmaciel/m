...
#ifndef ElecReactionTerm_3D_GalerkinH
#define ElecReactionTerm_3D_GalerkinH
...
class ElecReactionTerm_3D_Galerkin : public ElecReactionTerm
{
public :
  ElecReactionTerm_3D_Galerkin(unsigned nDimensions_, unsigned nNodes_, unsigned nVariables_, MITReM* mitrem_, BoundaryElementProps* boundaryElementProps_);
  virtual ~ElecReactionTerm_3D_Galerkin();
