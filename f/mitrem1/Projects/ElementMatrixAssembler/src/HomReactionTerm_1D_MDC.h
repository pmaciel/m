...
#ifndef HomReactionTerm_1D_MDCH
#define HomReactionTerm_1D_MDCH
...
class HomReactionTerm_1D_MDC : public HomReactionTerm
{
public :
  HomReactionTerm_1D_MDC(unsigned nDimensions_, unsigned nNodes_, unsigned nVariables_, MITReM* mitrem_, ElementProps* elementProps_);
  virtual ~HomReactionTerm_1D_MDC();
