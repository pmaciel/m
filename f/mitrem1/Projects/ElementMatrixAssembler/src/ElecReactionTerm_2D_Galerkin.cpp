...
//---------------------------------------------------------------------------
ElecReactionTerm_2D_Galerkin::ElecReactionTerm_2D_Galerkin(unsigned nDimensions_, unsigned nNodes_, unsigned nVariables_, MITReM* mitrem_, BoundaryElementProps* boundaryElementProps_) 
	: ElecReactionTerm(nDimensions_, nNodes_,nVariables_, mitrem_, boundaryElementProps_)
{
}
//---------------------------------------------------------------------------
ElecReactionTerm_2D_Galerkin::~ElecReactionTerm_2D_Galerkin()
{
}
//---------------------------------------------------------------------------
void ElecReactionTerm_2D_Galerkin::calcVec(double* boundaryElementVec, DoubleVectorList coordinates, DoubleVectorList concentrations, DoubleList potentials, DoubleList temperatures, DoubleList densities, DoubleList surfaceGasFractions, unsigned nElecReactions, IndexList elecReactions, double electrodePotential, unsigned nGasReactions, IndexList gasReactions)
{
...
//---------------------------------------------------------------------------
void ElecReactionTerm_2D_Galerkin::calcJac(double** boundaryElementJac, DoubleVectorList coordinates, DoubleVectorList concentrations, DoubleList potentials, DoubleList temperatures, DoubleList densities, DoubleList surfaceGasFractions, unsigned nElecReactions, IndexList elecReactions, double electrodePotential, unsigned nGasReactions, IndexList gasReactions)
{
	double surfaceGasFraction = 0.;
	for (unsigned m=0; m<nNodes; m++)
	{
		...
		for (unsigned m=0; m<nNodes; m++) 
		{
			...
			for (unsigned k=0; k<nAgentsRed; k++) 
			{
				...
				for (unsigned l=0; l<nAgentsRed; l++) 
				{
					...
					boundaryElementJac[eqmi][var(m,j)] += 2.*DvDCRed[m][r][l]*elementSize6*stoichRed;
				...
				for (unsigned l=0; l<nAgentsOxi; l++) 
				{
					...
					boundaryElementJac[eqmi][var(m,j)] += 2.*DvDCOxi[m][r][l]*elementSize6*stoichRed;
					boundaryElementJac[eqmi][var(p,j)] +=    DvDCOxi[p][r][l]*elementSize6*stoichRed;
				}

				// derivative of v(s) by U
				boundaryElementJac[eqmi][var(m,nIons)] += 2.*DvDU[m][r]*elementSize6*stoichRed;
			...
			for (unsigned k=0; k<nAgentsOxi; k++) 
			{
				...
				{
					unsigned j = mitrem->getElecReactionAgentsRed(s,l);
					boundaryElementJac[eqmi][var(m,j)] += 2.*DvDCRed[m][r][l]*elementSize6*stoichOxi;
				...
				{
					unsigned j = mitrem->getElecReactionAgentsOxi(s,l);
					boundaryElementJac[eqmi][var(m,j)] += 2.*DvDCOxi[m][r][l]*elementSize6*stoichOxi;
					boundaryElementJac[eqmi][var(p,j)] +=    DvDCOxi[p][r][l]*elementSize6*stoichOxi;
				}

				// derivative of v(s) by U
				boundaryElementJac[eqmi][var(m,nIons)] += 2.*DvDU[m][r]*elementSize6*stoichOxi;
