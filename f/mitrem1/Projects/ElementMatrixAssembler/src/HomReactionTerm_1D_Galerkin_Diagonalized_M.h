...
#ifndef HomReactionTerm_1D_Galerkin_Diagonalized_MH
#define HomReactionTerm_1D_Galerkin_Diagonalized_MH
...
class HomReactionTerm_1D_Galerkin_Diagonalized_M : public HomReactionTerm
{
public :
	HomReactionTerm_1D_Galerkin_Diagonalized_M(unsigned nDimensions_, unsigned nNodes_, unsigned nVariables_, MITReM* mitrem_, ElementProps* elementProps_);
	virtual ~HomReactionTerm_1D_Galerkin_Diagonalized_M();
