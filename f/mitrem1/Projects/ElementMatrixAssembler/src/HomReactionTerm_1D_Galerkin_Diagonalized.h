...
#ifndef HomReactionTerm_1D_Galerkin_DiagonalizedH
#define HomReactionTerm_1D_Galerkin_DiagonalizedH
...
class HomReactionTerm_1D_Galerkin_Diagonalized : public HomReactionTerm
{
public :
	HomReactionTerm_1D_Galerkin_Diagonalized(unsigned nDimensions_, unsigned nNodes_, unsigned nVariables_, MITReM* mitrem_, ElementProps* elementProps_);
	virtual ~HomReactionTerm_1D_Galerkin_Diagonalized();
