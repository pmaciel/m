...
#ifndef TimeTerm_1D_GalerkinH
#define TimeTerm_1D_GalerkinH
...
class TimeTerm_1D_Galerkin : public TimeTerm
{
public :
  TimeTerm_1D_Galerkin(unsigned nDimensions_, unsigned nNodes_, unsigned nVariables_, MITReM* mitrem_, ElementProps* elementProps_);
  virtual ~TimeTerm_1D_Galerkin();
