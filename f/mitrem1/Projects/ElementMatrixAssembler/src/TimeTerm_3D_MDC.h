...
#ifndef TimeTerm_3D_MDCH
#define TimeTerm_3D_MDCH
...
class TimeTerm_3D_MDC : public TimeTerm
{
public :
	TimeTerm_3D_MDC(unsigned nDimensions_, unsigned nNodes_, unsigned nVariables_, MITReM* mitrem_, ElementProps* elementProps_);
	virtual ~TimeTerm_3D_MDC();
