...
#define TecplotBinaryFileVersion 107 /* copied form GLOBAL.h */
#define VersionString "PREPLOT V11.00-02/13/2006  Copyright (C) Tecplot, Inc. 1987-2006.\n"
...
/*
 * Need to define these because we can't include "UNICODESTR.h"
 */
...
#if defined PLOT3D
static void Plot3D_ExtractBlock(LgIndex        IVar,
                                LgIndex        Plane,
                                LgIndex        Grid,
                                short          IJKSetting)
{
      ...
      case 'I' : /* I is Constant */
        {
          ...
          for (J = 0; J < JMax; J++)
            WriteR(BlckFile,
                   Plot3DVarArray[IVar][IJKOffset(Plane,J,K, IMax,JMax)],
                   FieldDataType_Float);
        } break;
      case 'J' : /* J is Constant */
        {
          ...
          for (I = 0; I < IMax; I++)
            WriteR(BlckFile,
                   Plot3DVarArray[IVar][IJKOffset(I,Plane,K, IMax,JMax)],
                   FieldDataType_Float);
        } break;
      case ' ' : /* Unknown */
      case 'K' : /* K is Constant */
        {
          ...
          for (I = 0; I < IMax; I++)
            WriteR(BlckFile,
                   Plot3DVarArray[IVar][IJKOffset(I,J,Plane, IMax,JMax)],
                   FieldDataType_Float);
        } break;
    }
# undef IJKOffset
...
#if defined PLOT3D
void Plot3D_DumpZoneStart(void)
{
  int J;
  ...
  WriteI(BlckFile,0); /* has passive varaibles */
                      ...
                      if (InFile_q)
                        {
                          ...
                          if (Plot3DNumGrids != AssignLgIndex(CurTValue))
                            ErrorMessage("inconsistant .g and .q files",FALSE);
                        }
                      if (InFile_f)
                        {
                          Plot3D_GetToken(InFile_f,TRUE);
                          if (Plot3DNumGrids != AssignLgIndex(CurTValue))
                            ErrorMessage("inconsistant .g and .f files",FALSE);
                        }
                    }
                      ...
                      case MODE_1D :
                        {
                          ...
                          printf("Var  : ");
                          for (J = 0; J < NumVars; J++)
                            Plot3D_ExtractBlock(J,2,Plot3DCurGrid,' ');
                          CurZone++;
                        } break; /* MODE_1D */
                      case MODE_2D :
                        {
                          ...
                          printf("Var  : ");
                          for (J = 0; J < NumVars; J++)
                            Plot3D_ExtractBlock(J,0,Plot3DCurGrid,' ');
                          CurZone++;
                        } break; /* MODE_2D  */
                      case MODE_3DP :
                      case MODE_3DW :
                                  ...
                                  if (inset(I,Plot3DISet))
                                    {
                                      ...
                                      if (Echo)
                                        ...
                                        printf("Var:");
                                      for (N = 0; N < NumVars; N++)
                                        Plot3D_ExtractBlock(N,I,Plot3DCurGrid,'I');
                                      CurZone++;
                                    }
                                } /* for I */
                                  ...
                                  if (inset(J,Plot3DJSet))
                                    {
                                      ...
                                      if (Echo)
                                        ...
                                        printf("Var:");
                                      for (N = 0; N < NumVars; N++)
                                        Plot3D_ExtractBlock(N,J,Plot3DCurGrid,'J');
                                      CurZone++;
                                    }
                                } /* for J */
                                  ...
                                  if (Fetch)
                                    {
                                      ...
                                      if (Echo)
                                        ...
                                        printf("Var:");
                                      for (N = 0; N < NumVars; N++)
                                        Plot3D_ExtractBlock(N,K,Plot3DCurGrid,'K');
                                      CurZone++;
                                    }
                                }
                            }
                      ...
                      case MODE_UNSTRUCTURED :
                        {
                          ...
                          WriteI(PlotFile,(LgIndex)FEBLOCK);
                          WriteI(PlotFile,-1); /* No Color */
                          IMax[CurZone] = Plot3DIDim[Plot3DCurGrid];
                          ...
                          if (Plot3DJDim[Plot3DCurGrid] > 0)
                            {
                              ...
                              WriteI(PlotFile,0); /* Triangles*/
                            }
                          else
                            {
                              WriteI(PlotFile,Plot3DKDim[Plot3DCurGrid]);
                              WriteI(PlotFile,2); /* Tetrahedrons*/
                            }
#if !defined TECPLOTKERNEL
                          printf("Var:");
#endif
                          ...
                          if (PreplotIsOk && ZoneIsEnabled)
                            {
                              ...
                              if (FaceNeighborConnections != 0 && PreplotIsOk)
