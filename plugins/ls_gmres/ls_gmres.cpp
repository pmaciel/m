...
Register< mlinearsystem< double >,ls_gmres > ls_gmres("ls_gmres","linear system solver, using GMRES (double p.)");
 ...
 *                                                                         *
 *=========================================================================*/
int ls_gmres::iluk(int *n, double *a, int *ja, int *ia, int *lfil,
...
double ls_gmres::ddot(int *n, double *dx, int *incx, double *dy, int *incy)
{
  /* System generated locals */
  int i__1;
  double ret_val;
...
int ls_gmres::daxpy(int *n, double *da, double *dx, int *incx, double *dy, int *incy)
{
    /* System generated locals */
    int i__1;
...
double ls_gmres::dnrm2(int *n, double *dx, int *incx)
{
 ...
 *                                                                         *
 *=========================================================================*/
void ls_gmres::amux(int *n, double *x, double *y, double *a, int *ja, int *ia)
{
   /* System generated locals */
   int i__1, i__2;
 ...
 *                                                                         *
 *=========================================================================*/
void ls_gmres::lusol(int *n, double *y, double *x, double *alu, int *jlu, int *ju)
{
   /* System generated locals */
   int i__1, i__2;
 ...
 *=========================================================================*/
void ls_gmres::pgmres(int *n, int *im, double *rhs, double *sol, double *vv,
...
L121:
   ...
   if (*iout>0)
     std::cout << "ls_gmres: iteration/residual: " << its << '/' << ro << std::endl;
