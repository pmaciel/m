...
static char *cvs_wrapint_id =
  "$Id: md_wrap_intel_c.c,v 3.13 1996/04/26 22:38:30 sahutch Exp $";
#endif
...
int osf_exit(int ignore)

{
  (void) fprintf(stderr, "Killing all nodes due to error.\n");
  kill(0, SIGKILL);
}
