...
extern void   AZ_reorder_vec(double vec[], int data_org[], int update_index[],
			     int rpntr[]);
extern void   AZ_invorder_vec(double vec[], int data_org[], int update_index[], int rpntr[],double *);
...
extern void   AZ_reorder_matrix_mod(int N_update, int bindx[],
                                    int update_index[], int extern_index[],
                                    int indx[], int rnptr[], int bnptr[],
                                    int N_external, int cnptr[], int option,
                                    int);
...
extern void   AZ_transform_mod(int proc_config[], int *external[], int bindx[],
                               int update[], int *update_index[],
                               int *extern_index[], int *data_org[], int N_update,
                               int indx[], int bnptr[], int rnptr[], int *cnptr[],
                               int mat_type);
